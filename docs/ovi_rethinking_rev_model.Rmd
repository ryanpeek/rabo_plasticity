...
coeftab(mS1dL, mS1dQ, mS1Qcv, mS1t, mS1tCV)
...
dens( logistic(simQcv) , xlab="probability breed" )
...
# test plot
plot( DOWY ~ temp_7_max , data=d2sb, pch=ifelse(d2sb$WY_id==1, 16, 21), col=ifelse(d2sb$REG_id==0, rangi2, "red"), cex=2.5)
...
# ggplot version
ggplot() + ylim(c(-2,2.5)) + xlim(c(-1.5,3)) + theme_light() + 
